	...
	<div class="previous" style="margin-top:20px">
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM data_pendatang ORDER BY id DESC") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								<a href="edit_pendatang.php?id='.$data['id'].'" class="badge badge-warning">Edit</a>
								<a href="delete_pendatang.php?id='.$data['id'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
