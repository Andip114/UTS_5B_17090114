...
<body>
	...
	<br/>
	<ul>
	<h3>Data Keselurahan Penduduk</h3>
</ul>
	<tr>
    <nav>
        <ul>
        	<img alt="Penduduk" src="penduduk.jfif"/>
            <h3><a href="list_penduduk.php">Lihat Data Penduduk</a></h3>

            <img alt="Kelahiran" src="kelahiran.jpg"/>
            <h3><a href="list_kelahiran.php">Lihat Data Kelahiran</a></h3>

            <img alt="Penduduk" src="kematian.jpg"/>
            <h3><a href="list_kematian.php">Lihat Data Kematian</a></h3>

            <img alt="Pendatang" src="pendatang.jpg"/>
            <h3><a href="list_pendatang.php">Lihat Data Pendatang</a></h3>
        </ul>
    </nav>
<hr>
    <ul>
